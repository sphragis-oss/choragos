...
make vet      # go vet ./...
make fmt      # go fmt ./...
make build    # build the choragos binary
make run      # run the TUI orchestrator
```
...
Choragos is licensed under [Apache 2.0](LICENSE). By contributing, you agree
